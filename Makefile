...
dracula:	player_dracula.o dracula.o dracula_view.o Queue.o ${OBJS} ${LIBS}
hunter:		player_hunter.o hunter.o hunter_view.o Queue.o ${OBJS} ${LIBS}
...
game_view.o:	game_view.c game_view.h places.h game.h Queue.h
